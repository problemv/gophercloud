...
func DeleteMessage(client *gophercloud.ServiceClient, queueName string, messageId string, clientId string, opts DeleteOptsBuilder) (r DeleteResult) {
